...
public class WebSecurityConfig{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers(HttpMethod.GET,"/descritores/buscarPorDisciplina*").permitAll()
                .antMatchers(HttpMethod.GET,"/descritores").permitAll()
                .antMatchers(HttpMethod.GET,"/recursos").permitAll()
                .antMatchers(HttpMethod.GET,"/recursos/buscarPorId/*/*").permitAll()
                .antMatchers(HttpMethod.GET,"/recursos/buscarPorDisciplina/*").permitAll()
                .antMatchers(HttpMethod.GET,"/planosDeAula").permitAll()
                .antMatchers(HttpMethod.POST,"/planosDeAula/salvar").permitAll()
                .antMatchers(HttpMethod.GET,"/planosDeAula/buscaSimples/*/*").permitAll()
                .antMatchers(HttpMethod.GET,"/planosDeAula/buscaAvancada/*/*").permitAll()
